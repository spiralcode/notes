...
$id(ir).innerHTML='<div title="Note Options" class="noteoptions" onclick="showOptions('+ir+')"><img style="width:20px; height:20px;" src = "'+image+'"/></div><div class="timeslot">'+frmtime+'</div><div class="contentslot">'+ele+'</div>'+imlist+'<div class="daysago">'+timeago+'</div>';
...
//$id(id+'_opt').style.display='none';
  $( "#"+id+'_opt' ).effect( "fade", "fast",function() {$id(id+'_opt').style.display="none";} );
...
<tr><td onclick="showMsg('peoples.php',{title:'Peoples',iframe: true});">Peoples</td></tr>
