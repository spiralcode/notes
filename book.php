...
$id(ir).innerHTML='<div title="Note Options" class="noteoptions" onclick="showOptions('+ir+')"><img class="note_settings_icon" style="width:20px; height:20px;" src = "'+image+'"/></div><div class="timeslot"><span onclick="datesearch(\''+searchFormat+'\',\'init\');" style="cursor:pointer;" title="View notes of this date">'+frmtime+'</span></div><div class="contentslot">'+ele+'</div>'+imlist+'<div class="daysago">'+timeago+'</div>';
