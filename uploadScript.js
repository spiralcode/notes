...
function FileDragHover(e)
{
	e.stopPropagation();
	e.preventDefault();
	$id("attachArea").style.border="1px groove #48655B";
	$id("attachArea").style.borderBottom="none";
...
function FileDragOut(e)
{
	...
	e.stopPropagation();
	e.preventDefault();
	$id("attachArea").style.border="1px dotted #7192A8";
	$id("attachArea").style.borderBottom="none";
	}
...
function ParseFile(file)
{
	if(file.type=='image/jpeg'||file.type=='image/png')
		...
		if (file.type.indexOf("image") == 0) {
			...
			fileList(e.target.result,file.name);
			uploadfile(file);
			}
...
function init()
{
	var fileselect = $id("fileselect"),attachArea=$id('attachArea');
	fileselect.addEventListener("change",FileSelectHandler,false);
	var xhr = new XMLHttpRequest();
	if(xhr.upload)
		{
		attachArea.addEventListener("dragover",FileDragHover,false);
		attachArea.addEventListener("dragleave",FileDragOut,false);
		attachArea.addEventListener("drop",FileSelectHandler,false);
...
notey.notify('',{text:text,iframe:false,width:500,height:0});
            ...
            else
                {
        			var reader = new FileReader();
                                ...
                                reader.readAsDataURL(file);
            document.getElementsByName(file.name)[0].setAttribute('class','uploaded');
          var dataimage='data:image/png;base64,'
                               //document.getElementsByName(file.name)[0].innerHTML='<img style="border:none; width:20px; height:20px;" src = "'+dataimage+'">';
	    document.getElementsByName(file.name)[0].style.backgroundRepeat='no-repeat';
            	   document.getElementsByName(file.name)[0].dataset.uploaded='1';}
          }
                        });}
