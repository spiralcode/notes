...
$id('spinner').style.display='block';
	...
	notey.get(url,function(data)
	{
		...
		{
	imlist+='<div class="imgspace"><a target="blank" href="../image.php?id='+json[init].ilist[0][imlistindex]+'" target="_blank"><img src="../image.php?id='+json[init].ilist[0][imlistindex]+'&thumb&size=50x50"/></a></div>';
	imlistindex++;
		}
