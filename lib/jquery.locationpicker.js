...
(function( $ ){
  ...
  $.fn.locationPicker = function( options ) {  
    ...
    console.log(detected_lat+' | '+detected_lng);
    var currentLatlng = new google.maps.LatLng(detected_lat, detected_lng);
    var myOptions = {
        zoom: 18,
	...
	var setPosition = function(latLng, viewport){
        ...
        getPlaceImage(latLng.lat()+","+latLng.lng());
    ...
    return this.each(function() {        
		...
		$this.focus(function(){
			...
			$lp.css({
				left: $inputOffset.left-$inputOffset.left+10,
